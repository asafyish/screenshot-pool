...
function ScreenshotPool(options) {
	...
	this.options.log = this.options.log || false;
	this.options.min = this.options.min || 0;
	this.options.max = this.options.max || 10;
	this.options.defaultTimeout = this.options.defaultTimeout || 1000;
	this.options.maxTimeouts = this.options.maxTimeouts || 3;
